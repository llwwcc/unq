				...
				<view class="post_right">
					...
					<view class="toolbar">
						...
						<view class="like" @tap="like(index)">
							<image :src="post.islike===0?imgUrl+'/upload/static/index/islike.png':imgUrl+'/upload/static/index/like.png'"></image>
						</view>
						<view class="comment" @tap="comment(index)">
							<image src="imgUrl+'/upload/static/index/comment.png'"></image>
						</view>
					</view>
					<!-- 赞／评论区 -->
					<view class="post-footer">
						<view class="footer_content">
							<image class="liked" src="imgUrl+'/upload/static/index/liked.png'"></image>
